  ...
  render() {
    ...
    return (
           <Segment.Group>
                ...
                <Item.Group>
                  <Item>
                    ...
                    <Item.Content>
                      ...
                      {event.cancelled && 
                        <Label style={{top: '-40px'}} ribbon='right' color='red' content='This EvenHas Been Cancelled' />
                      }
                    </Item.Content>
                  </Item>
                </Item.Group>
              ...
              <Segment>
                <span>
                  <Icon name="clock" /> {format(event.date.toDate(), 'dddd MMMM Do')} at {' '} {format(event.date.toDate(), 'h:mm a')} |
